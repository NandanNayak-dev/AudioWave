          ...
          {newAlbumDetails && (
            <div className='relative pt-24 ml-5'>
              <Header
                ...
                image={
                  Array.isArray(newAlbumDetails.data?.image)
                    ? newAlbumDetails.data?.image[2]?.link || newAlbumDetails.data?.image[1]?.link || newAlbumDetails.data?.image[0]?.link || newAlbumDetails.data?.image[2]?.url || newAlbumDetails.data?.image[1]?.url || newAlbumDetails.data?.image[0]?.url
                    : typeof newAlbumDetails.data?.image === 'string'
                    ? newAlbumDetails.data?.image
